		...
		pass {   
			...
			*/
			...
			float4 frag (v2f i) : COLOR {
				...
				result = result+float4(color_image15.rgb*color_image15.a*1*((1))*color_xman_mask1.r*color_xman_mask0.a*color_xman_mask0.r,color_image15.a*1*((1))*color_xman_mask1.r*color_xman_mask0.a*color_xman_mask0.r*(rootTexColor.a - result.a));
